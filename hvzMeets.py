...
def findBestTimeSlots(day1, day2):
    ...
    for a in range(len(day1[0])):
        ...
        for b in range(len(day2[0])):
            ...
            in_a_not_b = set(avail_a) - set(avail_b)
            avail = list(in_a_not_b) + avail_b
...
def main():
    ...
    attend_all = set(players_m_t).intersection(set(players_w_t), set(friday_players))
